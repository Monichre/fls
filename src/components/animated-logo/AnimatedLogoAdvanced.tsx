...
export const AnimatedLogoAdvanced = () => {
  const draw = {
    ...
    visible: {
      ...
      opacity: 1,
      transition: {
        pathLength: {delay: 0.5, type: 'spring', duration: 1.5},
  ...
  return (
    <div style={{width: '100%', maxWidth: '600px', margin: '0 auto'}}>
      ...
      >
        <motion.g>
          <motion.defs>
            <motion.linearGradient id='92' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#fa71cd'></motion.stop>
              <motion.stop offset='100%' stopColor='#9b59b6'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='93' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#f9d423'></motion.stop>
              <motion.stop offset='100%' stopColor='#f83600'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='94' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#0064d2'></motion.stop>
              <motion.stop offset='100%' stopColor='#1cb0f6'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='95' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#f00978'></motion.stop>
              <motion.stop offset='100%' stopColor='#3f51b1'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='96' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#7873f5'></motion.stop>
              <motion.stop offset='100%' stopColor='#ec77ab'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='97' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#f9d423'></motion.stop>
              <motion.stop offset='100%' stopColor='#e14fad'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='98' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#009efd'></motion.stop>
              <motion.stop offset='100%' stopColor='#2af598'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='99' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#ffcc00'></motion.stop>
              <motion.stop offset='100%' stopColor='#00b140'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='100' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#d51007'></motion.stop>
              <motion.stop offset='100%' stopColor='#ff8177'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='102' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#a2b6df'></motion.stop>
              <motion.stop offset='100%' stopColor='#0c3483'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='103' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#7ac5d8'></motion.stop>
              <motion.stop offset='100%' stopColor='#eea2a2'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='104' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#00ecbc'></motion.stop>
              <motion.stop offset='100%' stopColor='#007adf'></motion.stop>
            </motion.linearGradient>
            <motion.linearGradient id='105' x1='0%' y1='0%' x2='100%' y2='0%'>
              <motion.stop offset='0%' stopColor='#b88746'></motion.stop>
              <motion.stop offset='100%' stopColor='#fdf5a6'></motion.stop>
            </motion.linearGradient>
          </motion.defs>
          ...
          >
            ...
            <motion.g
              transform='translate(84.09000396728516, 0)'
              initial={{opacity: 0}}
              animate={{opacity: 1}}
              transition={{duration: 0.7, delay: 0.5}}
            >
              <motion.g>
                <motion.g fill='#eeeeee' className='imagesvg'>
                  <motion.rect
                    fill='#eeeeee'
                    fillOpacity='0'
                    strokeWidth='2'
                  ...
                  >
                    ...
                    >
                      <motion.g>
                        <motion.svg
                          ...
                          variants={draw}
                        >
                          <motion.g transform='scale(1, 1) skewX(0)'>
                            <motion.defs>
                              <motion.filter id='58cCIoSQV_DPXxtk4qs1T'>
                      ...
                      <motion.g filter='url(#colors3506011312)'>
                        <motion.svg
                          xmlns='http://www.w3.org/2000/svg'
                    ...
                    <motion.mask id='3fa9de65-802c-4ebc-ba27-5e37f4c5ae2a'>
                      <motion.g fill='white'>
                        <motion.svg
                          xmlns='http://www.w3.org/2000/svg'
                          xmlnsXlink='http://www.w3.org/1999/xlink'
                  ...
                  <motion.defs>
                    <motion.filter id='colors3506011312'>
                      <motion.feColorMatrix
                        type='matrix'
                        values='0 0 0 0 0.9296875  0 0 0 0 0.9296875  0 0 0 0 0.9296875  0 0 0 1 0'
                    ...
                    <motion.filter id='colorsf7090211796'>
                      <motion.feColorMatrix
                        type='matrix'
                    ...
                    <motion.filter id='colorsb4979894846'>
                      <motion.feColorMatrix
                        type='matrix'
