...
import {animate, createScope, createTimeline, svg, stagger} from 'animejs'
...
export const AnimatedLogo = () => {
  ...
  useEffect(() => {
    ...
    scopeRef.current = createScope({root}).add((scope) => {
      console.log('🚀 ~ scopeRef.current=createScope ~ scope:', scope)
      const timeline = createTimeline({
        easing: 'easeInOutQuad',
        loop: true,
      })
      // Get all the paths we want to animate
      const textPaths = scope.root.querySelectorAll('path')
      const iconPaths = scope.root.querySelectorAll('.image-svg-icon path')
      const circlePath = scope.root.querySelectorAll('.circle-path')

      // Animate text paths (the "conduit" text)
      timeline.add(svg.createDrawable(textPaths), {
              ...
              <g>
                <g fill='#eeeeee' className='imagesvg'>
                  ...
                  <svg
                    ...
                    width='28.38338777414839'
                    height='28.38338777414839'
                    className='image-svg-svg bn circular-logo'
                    ...
                    >
                      <g>
                        <svg
                          ...
                          clipRule='evenodd'
                          width='60'
                          className='circular-logo-background'
                          height='60'
                      ...
                      <g filter='url(#colors3506011312)'>
                        <svg
                          ...
                          aria-label='C icon'
                          className='circular-logo-icon icon-svg'
                        >
                          <path
